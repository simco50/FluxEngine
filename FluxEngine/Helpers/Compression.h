...
{
public:
	static bool Decompress(void *pInData, size_t inDataSize, std::vector<char> &outData)
	{
	...
	static bool Compress(void *pInData, size_t inDataSize, std::vector<char> &outData)
	{
		const size_t BUFSIZE = 128 * 1024;
