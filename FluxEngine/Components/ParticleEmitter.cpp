...
void ParticleEmitter::LoadEffect()
{
...
void ParticleEmitter::Render()
{
	...
	XMFLOAT4X4 viewProjection = m_pGameContext->Scene->Camera->GetViewProjection();
	XMFLOAT4X4 viewInverse = m_pGameContext->Scene->Camera->GetViewInverse();
